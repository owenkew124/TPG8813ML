...
parser.add_argument("--save_path", help="save path of vocab file", type=str, default='./PagPassGPT/tokenizer/vocab.json')
parser.add_argument("--max_len", help="max length of password in datasets", default=20, type=int)

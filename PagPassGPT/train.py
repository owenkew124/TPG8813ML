...
if __name__ == '__main__':
    ...
    parser.add_argument("--vocabfile_path", help="path of vocab file", type=str, default="./PagPassGPT/tokenizer/vocab.json")
    parser.add_argument("--model_path", help="directory to save model", type=str, default="./PagPassGPT/model/")
    parser.add_argument("--log_path", help="directory of log", type=str, default="./PagPassGPT/log/")
    ...
    parser.add_argument("--input_size", help="should be larger than (2*max len of password + 3), default is 43 according to max_len=20", type=int, default=43)
    ...
    generator = lambda examples: tokenizer(examples['text'], max_len=input_size, padding=True)
    train_dataset = train_dataset.map(generator, batched=True)
